      ...
      <div className="mx-auto max-w-6xl w-full px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-3 ml-2">
            <a href="https://www.instagram.com/zetabytenexus/" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.linkedin.com/company/zetabytenexus/" target="_blank" rel="noopener noreferrer"
               aria-label="LinkedIn"
               className="text-muted hover:text-accent transition-colors duration-200">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
            ...
            <a href="https://www.facebook.com/profile.php?id=61591846348291" target="_blank" rel="noopener noreferrer"
               aria-label="Facebook"
               className="text-muted hover:text-accent transition-colors duration-200">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
